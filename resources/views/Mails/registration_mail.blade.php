...
<head>
    @php
        \Log::info('EmailJob started for user: ' . $user);
    @endphp
    <meta charset="UTF-8">
                            ...
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr class="es-visible-simple-html-only">
                                        <td align="left" class="es-struct-html"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://etsiqzy.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png"
                                                                        alt="" width="100"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hey {{ $user->name }}. Please paste the code
                                                                        given below to
                                                                        verify your email address and confirm that you
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <h1
                                                                        style="Margin:0;font-family:'trebuchet ms', 'lucida grande', 'lucida sans unicode', 'lucida sans', tahoma, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:bold;line-height:78.2px;color:#ffffff">
                                                                        <span
                                                                            style="background:#999999; padding: 20px 40px 20px 40px;">{{ $user->verification_code }}</span>
                                                                    </h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
